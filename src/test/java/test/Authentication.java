...
public class Authentication {
    public static void main(String[] args)  {
        ...
        op.addExtensions(new File("src/test/Drivers/Auth.crx"));
        ChromeDriver driver = new ChromeDriver(op);
        driver.get("chrome-extension://enhldmjbphoeibbpdhmjkchohnidgnah/popin.html");


        driver.findElement(By.id("url")).sendKeys("https://www-stage.harborfreight.com");
        //driver.findElement(By.id("url")).sendKeys("https://stage.harborfreight.com");
        ...
        driver.findElement(By.id("url")).sendKeys("https://api-stage.harborfreight.com");
        //driver.findElement(By.id("url")).sendKeys("https://stage-shop.harborfreight.com");
        driver.findElement(By.id("username")).sendKeys("stage");
        driver.findElement(By.id("password")).sendKeys("Sup3rs3cr3t#!");
        ...
        //driver.get("https://stage.harborfreight.com");
        ...
        if ( Ordernumber.equals(1011900173) ){
            System.out.println(Ordernumber + " 2 ");

            driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/div[2]/div[2]/div/div[1]/div/div[1]/ul/li[2]/a")).click();
        }
